...
!define VERSION "1.0"
!define ALT_VER "1_0"
!define PLUG "Auto Close Last.FM Scrobbler"
!define PLUG_ALT "AutoClose Last.FM Scrobbler"
!define PLUG_FILE "gen_autoCloseLastFM"
...
OutFile "${PLUG_ALT} v${ALT_VER}.exe"
...
; just to be sure, request execution level
